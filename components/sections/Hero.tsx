    ...
    <section className="relative min-h-[75vh] flex items-center justify-center px-8 sm:px-16">
      ...
      <div className="max-w-2xl z-10 text-left">
        ...
        <p className="mt-4 text-lg sm:text-xl text-gray-400">
          I started as a graphic designer, then dove into building digital experiences with code. My work bridges creativity and technology with a focus on design, direction, and front-end development.
        </p>
